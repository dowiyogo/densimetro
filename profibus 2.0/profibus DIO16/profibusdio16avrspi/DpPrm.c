...
DP_ERROR_CODE     eRetValue;
   ...
   eRetValue = DP_OK;
   /*ver valor bPrmLength
   start_spis();
   write_spis(bPrmLength);
   //_delay_ms(20);
   write_spis(*pbPrmData);
   write_spis(*pbPrmData+1);
   /*write_spis(*pbPrmData+2);
   write_spis(*pbPrmData+3);
   write_spis(*pbPrmData+4);
   write_spis(*pbPrmData+5);
   close_spis();
   */
