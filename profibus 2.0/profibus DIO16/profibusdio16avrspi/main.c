...
void init_PWM(void)
{
    ...
    //TCCR0B|=(1<<CS00)|(1<<CS02)|(1<<CS01);
	TCCR0B|=(1<<CS00)|(1<<CS01);
	//TCCR0B|=(1<<CS01);
    //TCCR1B|=(1<<WGM00)|(1<<WGM01)|(1<<COM0B1);
  ...
  while(1)
   {
	...
	/*if (pendiente){
	ciclo +=2;if (ciclo>250)pendiente=0;
	}
	
	if(!pendiente){
	ciclo -=2;	if (ciclo<5)pendiente=1;
	}*/
	//_delay_ms(1);
...
datain=spi_slaveReceiveword();
//sDpAppl.abDpInputData[0]=spi_slaveReceive();
