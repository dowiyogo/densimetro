...
extern void                   Swap16                               ( uint16_t MEM_PTR w );
...
/*------------------------------------------------------------------------*/
   ...
   extern void                UserTimeStampParameter        ( uint8_t bSlotNr, uint8_t bRisingEdge, uint8_t bFallingEdge );
   extern void                UserTimeStampNewData          ( uint8_t bSlotNr, uint8_t bOldData, uint8_t bNewData );

   extern void                TimeStamp_Switchover          ( uint8_t bRedState );
   extern void                TimeStamp_SwitchoverDone      ( uint8_t bRedState );
   extern void                RedDrvSwitchWaitingToBackup   ( uint8_t bChannel );

   extern void                TimeStamp_SetChannel          ( uint8_t bChannel );
   extern void                TimeStamp_InitChannel         ( uint8_t bChannel );

   extern void                SetSyncCycleTime              ( uint32_t dwTimeBaseDp, uint16_t wDpCycleTime );
   extern void                PrintNewClockEvent            ( void );
#endif /* #if DP_TIMESTAMP */
