...
// Arduino Serial
#ifndef _SERIAL_PORT
#define _SERIAL_PORT			"/dev/ttyUSB0"					// Arduino serial port
#endif
#define _UART_BAUD_RATE			1200							// For Arduino Serial
#define _UART_PROTOCOL			SERIAL_8O1						// For Arduino use
#define _STDIN_READ												// READ METHOD USE IN DATAindicate

/******** APPLICATION LAYER PARAMETERS *********/
#define _UNIVERSAL_COMMAND_REVISION 	0						// Universal Command Revision version

/******** DATA LINK LAYER PARAMTERS ************/
// General
#define _DEVICE_ID_SIZE			3								// Device ID bytes length
#define _DEVICE_POLLING_ADDR    ((char)0x04)					// Default Device Polling Address
#define _DEVICE_MANUF_ID        ((char)0x00)					// Default manufacturer ID
#define _DEVICE_TYPE            ((char)0x01)					// Default device type
#define _DEVICE_REVISION        ((char*)"00")					// Default 3 bytes device revision
